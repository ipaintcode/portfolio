...
const SteamBattle = props => (
  <section>
    ...
    <p>Since the Steam API does not support <strong>CORS</strong>, I had to create a backend proxy. Since I love to write APIs so much, I was grateful for the chance to do so. Originally I built a Node/Express server to handle the job, but later took this as an opportunity to learn <strong>Google Cloud Functions</strong> and converted my endpoints over.</p>
    ...
    <Buttons close={props.close} repo={'steam-battle'} />
  </section>
);
