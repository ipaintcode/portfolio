...
const Condictor = props => (
  <section className="Condictor">
    <img src="https://cloud.githubusercontent.com/assets/18176333/26330669/b2e90af6-3f12-11e7-96a3-b5349ef61d8f.png" alt="Condictor" />
    <h1>Condictor</h1>
    ...
    <Buttons close={props.close} repo={'condictor'} />
  </section>
);
